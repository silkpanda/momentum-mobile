// src/components/meals/EditRestaurantModal.tsx
...
interface EditRestaurantModalProps {
    ...
    restaurant: any;
    onClose: () => void;
    onRestaurantUpdated: (restaurant: any) => void;
}
...
export default function EditRestaurantModal({ visible, restaurant, onClose, onRestaurantUpdated }: EditRestaurantModalProps) {
    ...
    const handleSubmit = async () => {
        ...
        setIsLoading(true);
        try {
            const response = await api.updateRestaurant(restaurant._id || restaurant.id, formData);
                ...
                <View style={[styles.modalContainer, { backgroundColor: theme.colors.bgSurface }]}>
                    ...
                    <View style={styles.header}>
                        <View style={styles.headerTitle}>
                            ...
                            <Text style={[styles.title, { color: theme.colors.textPrimary }]}>Edit Restaurant</Text>
                        </View>
