// src/components/meals/EditRecipeModal.tsx
...
interface EditRecipeModalProps {
    ...
    recipe: any;
    onClose: () => void;
    onRecipeUpdated: (recipe: any) => void;
}
...
export default function EditRecipeModal({ visible, recipe, onClose, onRecipeUpdated }: EditRecipeModalProps) {
    ...
    React.useEffect(() => {
        if (recipe) {
            setFormData({
                ...
                prepTime: recipe.prepTimeMinutes || recipe.prepTime || 15,
                cookTime: recipe.cookTimeMinutes || recipe.cookTime || 30,
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await api.updateMeal(recipe._id || recipe.id, apiData);
                ...
                <View style={[styles.modalContainer, { backgroundColor: theme.colors.bgSurface }]}>
                    ...
                    <View style={styles.header}>
                        <View style={styles.headerTitle}>
                            ...
                            <Text style={[styles.title, { color: theme.colors.textPrimary }]}>Edit Recipe</Text>
                        </View>
