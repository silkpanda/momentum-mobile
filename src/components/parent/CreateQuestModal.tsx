...
export default function CreateQuestModal({ visible, onClose, onQuestCreated }: CreateQuestModalProps) {
            ...
            <View style={styles.modalOverlay}>
                <View style={[styles.modalContent, { backgroundColor: theme.colors.bgSurface }]}>
                    <View style={styles.header}>
                        <Text style={[styles.title, { color: theme.colors.textPrimary }]}>New Quest</Text>
